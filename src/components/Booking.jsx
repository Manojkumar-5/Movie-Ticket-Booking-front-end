...
const getAllopentickets=async()=>{
    ...
    const response=await axios.get("https://movie-ticket-booking-backend.herokuapp.com/ticket/status/open");
...
const onSubmit=async(e)=> {
        ...
        await axios.post("https://movie-ticket-booking-backend.herokuapp.com/ticket/addTicket",bookingdata,
         {
          headers: {
                ...
                <div className="card-body border-bottom">
                    ...
                    <div className="list-group list-group-flush">
                        <div className="list-group-item">
                            <h5 className="card-title">Movie Booking Details</h5>
                            <div className="form-row">
